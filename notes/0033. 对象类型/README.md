...
- [1. 本节内容](#1-本节内容)
- [2. 评价](#2-评价)
- [3. 对象类型章节速览](#3-对象类型章节速览)
- [4. 什么是 TypeScript 的对象类型？](#4-什么是-typescript-的对象类型)
- [5. 如何声明对象类型？](#5-如何声明对象类型)
  - [5.1. 多字段的声明](#51-多字段的声明)
  - [5.2. type 和 interface 都可以用来声明对象类型](#52-type-和-interface-都可以用来声明对象类型)
  - [5.3. 对象方法的声明](#53-对象方法的声明)
  - [5.4. 可选成员的声明](#54-可选成员的声明)
  - [5.5. 只读属性的声明](#55-只读属性的声明)
- [6. 对象类型有哪些约束规则？](#6-对象类型有哪些约束规则)
- [7. 如何读取对象属性的类型？](#7-如何读取对象属性的类型)
- [8. 可选属性与 undefined 属性有什么区别？「细节」](#8-可选属性与-undefined-属性有什么区别细节)
- [9. readonly 修饰符对嵌套对象有什么影响？](#9-readonly-修饰符对嵌套对象有什么影响)
- [10. 如何创建完全只读的对象？](#10-如何创建完全只读的对象)
- [11. 什么是属性名的索引类型？](#11-什么是属性名的索引类型)
- [12. 如何处理解构赋值的类型？](#12-如何处理解构赋值的类型)
- [13. 什么是“最小可选属性规则”？](#13-什么是最小可选属性规则)
- [14. 空对象 `{}` 在 TypeScript 中有什么特殊性？「不重要的细节」](#14-空对象--在-typescript-中有什么特殊性不重要的细节)
- [15. 如何强制使用没有任何属性的对象？「没啥用的小技巧」](#15-如何强制使用没有任何属性的对象没啥用的小技巧)
- [16. 引用](#16-引用)
...
<NotesTable :ids="['0099', '0100', '0101', '0102', '0103', '0104']" />

## 4. 什么是 TypeScript 的对象类型？
...
### 5.2. type 和 interface 都可以用来声明对象类型
...
## 14. 空对象 `{}` 在 TypeScript 中有什么特殊性？「不重要的细节」
