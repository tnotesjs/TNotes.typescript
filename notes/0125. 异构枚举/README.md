...
- [3. 🤔 什么是异构枚举？](#3--什么是异构枚举)
  - [3.1. 异构枚举](#31-异构枚举)
  - [3.2. 异构枚举的特点](#32-异构枚举的特点)
  - [3.3. 异构枚举的问题](#33-异构枚举的问题)
- [4. 🆚 异构枚举 vs 纯枚举](#4--异构枚举-vs-纯枚举)
- [5. 🤔 基本语法](#5--基本语法)
  - [5.1. 简单混合](#51-简单混合)
  - [5.2. 数字和字符串交替](#52-数字和字符串交替)
  - [5.3. 分段定义](#53-分段定义)
- [6. 🤔 初始化规则](#6--初始化规则)
  - [6.1. 字符串后必须初始化](#61-字符串后必须初始化)
  - [6.2. 数字后可以自动递增](#62-数字后可以自动递增)
  - [6.3. 初始化顺序](#63-初始化顺序)
- [7. 🤔 异构枚举的特性](#7--异构枚举的特性)
  - [7.1. 部分反向映射](#71-部分反向映射)
  - [7.2. 类型检查](#72-类型检查)
  - [7.3. 枚举成员类型](#73-枚举成员类型)
- [8. 🤔 使用场景](#8--使用场景)
  - [8.1. 场景 1：兼容旧代码](#81-场景-1兼容旧代码)
  - [8.2. 场景 2：特殊标记值](#82-场景-2特殊标记值)
  - [8.3. 场景 3：错误码系统](#83-场景-3错误码系统)
- [9. 🤔 常见错误和最佳实践](#9--常见错误和最佳实践)
  - [9.1. 错误 1：忘记字符串后的初始化](#91-错误-1忘记字符串后的初始化)
  - [9.2. 错误 2：期望字符串成员有反向映射](#92-错误-2期望字符串成员有反向映射)
  - [9.3. 错误 3：类型不一致导致的问题](#93-错误-3类型不一致导致的问题)
  - [9.4. 最佳实践](#94-最佳实践)
- [10. 🔗 引用](#10--引用)
